      ...
      <div className="container mx-auto px-4">
            ...
            <div className="flex gap-5">
              {[Globe, Send, Camera].map((Icon, i) => (
                <Link
                  key={i}
                  href="#"
                  className="p-3 bg-white/5 rounded-2xl hover:bg-yellow hover:text-darkblue transition-all duration-300 hover:-translate-y-1"
                >
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-gray-500 text-xs font-bold uppercase tracking-widest">
          ...
          <div className="flex items-center gap-6">
            <Link href="/careers" className="hover:text-lightblue transition-colors flex items-center gap-1.5">
